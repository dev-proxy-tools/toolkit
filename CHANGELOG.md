...
- Snippets: All snippets that reference schemas updated to use `v3.3.0` schema

## [1.34.0] - 2026-07-22

### Changed:

- Snippets: All snippets that reference schemas updated to use `v3.2.0` schema

## [1.32.0] - 2026-07-01

### Changed:

- Snippets: All snippets that reference schemas updated to use `v3.1.0` schema

## [1.30.0] - 2026-06-08

### Changed:

- Snippets: All snippets that reference schemas updated to use `v3.0.1` schema
- Agent Skill: Updated schema references to `v3.0.1`
...
- Snippets: All snippets that reference schemas updated to use `v2.4.0` schema

## [1.24.0] - 2026-04-27

### Changed:

- Snippets: All snippets that reference schemas updated to use `v2.3.4` schema

## [1.22.0] - 2026-04-24

### Changed:

- Snippets: All snippets that reference schemas updated to use `v2.3.3` schema

## [1.20.0] - 2026-04-24

### Changed:

- Snippets: All snippets that reference schemas updated to use `v2.3.2` schema

## [1.18.0] - 2026-04-14

### Changed:

- Snippets: All snippets that reference schemas updated to use `v2.3.1` schema
...
- Snippets: All snippets that reference schemas updated to use `v2.3.0` schema
...
- Snippets: All snippets that reference schemas updated to use `v2.0.0` schema
...
- Snippets: All snippets that reference schemas updated to use `v1.2.1` schema
